...
<!-- start service 2 -->
			...
			<div class="form">
					<!-- contact us-image -->
					<div style="text-align: center;">
						<img src="img/hosting.jpg " style="width: 300px; height: 180px;">
					</div>

				<div class="row">
						<h3>Web Hosting</h3>
							<p>
							 Whether you are a small business or a large corporate, you need to build an online 
							 brand identity that will help you to reach more customers and increase sales.<br>
							 Baotec Online Solutions will provide you with affordable and reliable web hosting services such as:
							 <ul><li>Domain name renewal</li></ul>
							 <ul><li>Domain name transfers</li></ul>
							 <ul><li>Domain name registration.</li></ul>
							 <ul><li>Domain name Privacy</li></ul>
							</p>
...
<!-- start service 3 -->
		<div class="form-container">
			<div class="form">
					<!-- contact us-image -->
					<div style="text-align: center;">
						<img src="img/software1.jpg " style="width: 300px; height: 180px;">
					</div>
...
<!-- start service 4 -->
	 <div class="form-container">
			<div class="form">
					<!-- contact us-image -->
					<div style="text-align: center;">
						<img src="img/mobile.jpg " style="width: 300px; height: 180px;">
					</div>

				<div class="row">
						<h3>Mobile Applications</h3>
							<p>
								Over the past few years, mobile app usage has increased rapidly all over 
								the world. As a result, the demand for mobile apps among large scale and small scale firms has been increasing gradually. <br>
								Inline with this demand, Baotech Online Solutions will build for your business  applications that will help you in delivering goods and services, boosting your Return on Investment(ROI) and in brand promotion. 
							</p>
			...
			<div class="form">
				...
				<div class="row">
						<h3>Online Marketing</h3>
							<p>
								Today's business environment is full of scrappy entreprenuers, large established corporations and small scale firms all battling out for market share. Due to the increased competitions organizations have to comeup with methods of surving in the market. <br>
								Baotech Online solutions helps organizations to implement online marketing solutions that help in:-
								<ul><li>Building Brand Awareness</li></ul> 
								<ul><li>Accomplishing Business Goals</li></ul>
								<ul><li>Increasing Business Revenue</li></ul> 
							</p>
